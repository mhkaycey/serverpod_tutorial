...
--
-- Class EventTemplate as table event_template
--
...
-- Indexes
CREATE UNIQUE INDEX "user_info_id_unique_idx" ON "users" USING btree ("userInfoId");

--
-- Class Venue as table venue
--
CREATE TABLE "venue" (
    "id" bigserial PRIMARY KEY,
    "ownerId" bigint NOT NULL,
...
--
-- Foreign relations for "event_template" table
--
...
--
-- Foreign relations for "events" table
--
...
--
-- Foreign relations for "venue" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('openmic', '20250308143150025', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250308143150025', "timestamp" = now();
